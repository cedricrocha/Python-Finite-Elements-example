...
# Cria a figura com as dimensões desejadas
...
#ax1.plot(x2,Tc2,"*--",color="green",ms=10,label="Elementos Finitos com nos={}".format(nos2))
...
#ax2.plot(x1,Tc,"o--",color="red",label='Elementos Finitos com nos={}' .format(nos))
#plt.plot(x, y, label='y = %.2f x' %A)
